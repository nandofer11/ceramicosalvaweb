...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-light dark:bg-gray-dark">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-dark dark:text-gray-light">
              Empresa Riojana dedicada a la fabricación y venta de ladrillos de arcilla.
            </p>
            <div className="pt-2">
              <p className="text-sm text-gray-dark dark:text-gray-light">
                RUC: 20450224775
          ...
          <div>
            <h3 className="text-base font-medium mb-4">Enlaces rápidos</h3>
            <ul className="space-y-2">
              <li>
                <Link 
                  href="/" 
                  className="text-sm text-gray-dark dark:text-gray-light hover:text-primary transition-colors"
                >
                  Inicio
                </Link>
              </li>
          ...
          {/* Column 3: Products */}
          <div>
            <h3 className="text-base font-medium mb-4">Nuestros productos</h3>
            <ul className="space-y-2">
              <li>
                <Link 
          ...
          <div>
            <h3 className="text-base font-medium mb-4">Contacto</h3>
            <div className="space-y-3">
              <p className="text-sm text-gray-dark dark:text-gray-light flex items-start">
              ...
              <p className="text-sm text-gray-dark dark:text-gray-light flex items-center">
                <svg className="h-5 w-5 mr-2 text-primary flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
