...
const WhatsAppButton = () => {
  ...
  const phoneNumber = '+51970584592'; // Número de WhatsApp de Cerámicos Alva
  const message = encodeURIComponent('Hola, vengo de la web de ceramicosalva.com. Quiero saber sobre...');
