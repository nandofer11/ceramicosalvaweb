          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {products.map((product, index) => (
              ...
              >
                ...
                {/* Footer con botón de cotizar */}
                <div className={`px-4 py-3 ${product.id === 'segunda' ? 'bg-gray-200' : 'bg-gray-50'} border-t ${product.id === 'segunda' ? 'border-gray-300' : 'border-gray-100'}`}>
                  <div className="flex justify-center">
                    <Button 
                      size="sm" 
                      className={`w-full text-sm ${product.id === 'segunda' ? 'bg-gray-600 hover:bg-gray-700' : ''}`}
                    >
                      <Link href="/cotizacion" className="flex items-center justify-center w-full">
                        <svg 
                        ...
                        >
                          ...
                          <path d="M20.452 3.5h-16.904c-1.126 0-2.048.922-2.048 2.048v12.904c0 1.126.922 2.048 2.048 2.048h16.904c1.126 0 2.048-.922 2.048-2.048v-12.904c0-1.126-.922-2.048-2.048-2.048zm-16.904 1h16.904c.576 0 1.048.472 1.048 1.048v12.904c0 .576-.472 1.048-1.048 1.048h-16.904c-.576 0-1.048-.472-1.048-1.048v-12.904c0-.576.472-1.048 1.048-1.048z"/>
                        </svg>
                        Cotizar
                      </Link>
                    </Button>
